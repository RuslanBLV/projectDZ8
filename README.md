...
Функция конвертации волюты в репозитории "src/convert.py"

Чтобы она функционировала нужно добавить ваш API ключ в файл .env.example

Если в транзакции валюта не в рублях, отдается запрос на сайт
